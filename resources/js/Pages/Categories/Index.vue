            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody>
                            <tr v-for="category in categories" :key="category.id" class="border-b dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition">
                                <td class="p-4 text-gray-700 dark:text-gray-300">{{ category.id }}</td>
                                <td class="p-4 font-medium text-gray-900 dark:text-white">{{ category.name }}</td>
                                <td class="p-4 text-gray-600 dark:text-gray-400">{{ category.description || 'N/A' }}</td>
                            ...
                            <tr v-if="categories.length === 0">
                                <td colspan="4" class="p-6 text-center text-gray-500 dark:text-gray-400 italic">No categories found. Click "Add Category" to create one!</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
