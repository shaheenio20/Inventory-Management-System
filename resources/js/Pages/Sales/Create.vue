                ...
                <div class="p-6 text-gray-900">
                    <form @submit.prevent="submit">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label for="customer_phone" class="block font-medium text-sm text-gray-700">Customer Phone</label>
                        ...
                        <div class="mt-6">
                            ...
                            <div class="space-y-4">
                                <div v-for="(item, index) in form.products" :key="index" class="grid grid-cols-1 md:grid-cols-4 gap-4 items-end border border-gray-200 rounded-lg p-4">
                                    ...
                                    <div>
                                        <label class="block font-medium text-sm text-gray-700">Unit Price</label>
                            ...
                            <button type="button" @click="addRow" class="mt-4 inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition">Add another product</button>
                        </div>
