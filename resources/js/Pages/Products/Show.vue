        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-3 space-y-2">
                <div class="mb-1 flex justify-end">
                    <Link href="/products" class="m-2 bg-indigo-600 text-white px-4 py-2 rounded-md hover:bg-indigo-700 transition font-bold">
                        Back to Products
                    </Link>
                </div>
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <div class="bg-gray-50 rounded-xl p-6">
                        <h3 class="font-bold text-gray-900 text-lg mb-3">Overview</h3>
                    ...
                    <div class="lg:col-span-2 bg-white rounded-xl shadow p-6">
                        <h3 class="font-bold text-gray-900 text-lg mb-4">Movement History</h3>
