                ...
                <div class="p-6 text-gray-900">
                    <form @submit.prevent="submit">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <!-- Stock Quantity -->
                            <div>
                                <label for="stock_quantity" class="block font-bold text-sm text-gray-700">Stock Quantity</label>
                            ...
                            <!-- Image -->
                            <div>
                                <label for="image" class="block font-bold text-sm text-gray-700">Update Product Image (Optional)</label>
