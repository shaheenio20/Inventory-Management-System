...
<head>
    ...
    <style>
        ...
        .sidebar-link:hover, .sidebar-link.active { background: rgba(255,255,255,0.15); border-radius: 4px; }
...
<div class="flex">
    ...
    <!-- ===== SIDEBAR ===== -->
    <nav class="sidebar bg-gray-900 text-white fixed top-0 left-0 flex flex-col z-50">
        <!-- Logo -->
    ...
    <div class="main-content flex-1 min-h-screen">
        ...
        <div class="bg-white shadow-sm px-6 py-3 flex items-center justify-between sticky top-0 z-40">
            ...
            <div class="flex items-center space-x-4">
                <div class="relative">
                    <input type="text" placeholder="Search..." class="pl-9 pr-4 py-1.5 bg-gray-100 rounded-full text-sm text-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-400 w-48">
                ...
                <a href="{{ route('profile.edit') }}" class="flex items-center space-x-2 text-gray-600 hover:text-gray-900 text-sm">
                    <div class="w-8 h-8 rounded-full bg-blue-500 flex items-center justify-center text-white text-sm font-bold">
                        {{ strtoupper(substr(auth()->user()->name, 0, 1)) }}
                    </div>
                </a>
