<x-admin-layout>
    ...
    <div class="bg-gradient-to-l from-slate-900 via-indigo-800 to-cyan-900 px-6 pt-8 pb-32 relative">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6">
                ...
                <!-- Total Products -->
                <div class="stat-card bg-white rounded-xl shadow-lg p-5">
                    ...
                    <p class="text-xs text-gray-400 mt-4 flex items-center">
                        <span class="text-green-500 font-semibold mr-1"><i class="fas fa-arrow-up"></i> 3.48%</span> Since last month
                    </p>
                </div>
                ...
                <div class="stat-card bg-white rounded-xl shadow-lg p-5">
                    ...
                    <p class="text-xs text-gray-400 mt-4 flex items-center">
                        <span class="text-red-500 font-semibold mr-1"><i class="fas fa-arrow-down"></i> 3.48%</span> Since last week
                    </p>
                </div>
                ...
                <div class="stat-card bg-white rounded-xl shadow-lg p-5">
                    <div class="flex justify-between items-start">
                        <div>
                            <p class="text-gray-400 text-xs font-bold uppercase tracking-wider">Sales (this month)</p>
                    ...
                    <p class="text-xs text-gray-400 mt-4 flex items-center">
                        <span class="text-orange-500 font-semibold mr-1"><i class="fas fa-arrow-down"></i> 1.10%</span> Since yesterday
                    </p>
                </div>
                ...
                <div class="stat-card bg-white rounded-xl shadow-lg p-5">
                    ...
                    <p class="text-xs text-gray-400 mt-4 flex items-center">
                        <span class="text-green-500 font-semibold mr-1"><i class="fas fa-arrow-up"></i> 12%</span> Since last month
                    </p>
                </div>
    ...
    <!-- Content Tables Section (overlaps the blue) -->
    <div class="px-6 -mt-20 max-w-7xl mx-auto pb-10">
        <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
            ...
            <div class="xl:col-span-2 bg-white rounded-xl shadow-lg overflow-hidden">
                <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100">
                    ...
                    <a href="#" class="text-xs text-blue-600 hover:underline font-medium">See All</a>
                </div>
                    ...
                    <table class="w-full text-sm">
                        ...
                        <tbody class="divide-y divide-gray-50">
                            ...
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-6 py-4 font-semibold text-gray-800">${{ number_format($sale->total_amount, 2) }}</td>
                            ...
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    <div class="w-full bg-gray-100 rounded-full h-1 mt-2">
                                        <div class="bg-red-400 h-1 rounded-full" style="width: {{ min(100, max(5, $product->stock_quantity * 10)) }}%"></div>
                                    </div>
                                </td>
                            </tr>
                            @empty
        ...
        <div class="grid grid-cols-1 xl:grid-cols-3 gap-6 mt-6">
            ...
            <div class="xl:col-span-2 bg-white rounded-xl shadow-lg p-6">
                ...
                <div class="space-y-4">
                        ...
                        <div class="flex-1 mx-4">
                            <div class="w-full bg-gray-100 rounded-full h-2">
                                <div class="bg-blue-500 h-2 rounded-full transition-all duration-500"
                                     style="width: {{ $totalProducts > 0 ? min(100, ($cat->products_count / $totalProducts) * 100) : 0 }}%">
                                </div>
                            </div>
                        </div>
                    ...
                    @empty
                    <p class="text-gray-400 italic text-sm text-center py-6">No categories yet. <a href="{{ route('categories.create') }}" class="text-blue-500 hover:underline">Create one</a>.</p>
                    @endforelse
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-lg p-6">
                ...
                <div class="space-y-3">
                    <a href="{{ route('products.create') }}" class="flex items-center space-x-3 p-3 rounded-lg border border-gray-100 hover:bg-blue-50 hover:border-blue-200 transition group">
                    ...
                    <a href="{{ route('categories.create') }}" class="flex items-center space-x-3 p-3 rounded-lg border border-gray-100 hover:bg-green-50 hover:border-green-200 transition group">
                    ...
                    <a href="#" class="flex items-center space-x-3 p-3 rounded-lg border border-gray-100 hover:bg-orange-50 hover:border-orange-200 transition group">
                    ...
                    <a href="#" class="flex items-center space-x-3 p-3 rounded-lg border border-gray-100 hover:bg-pink-50 hover:border-pink-200 transition group">
